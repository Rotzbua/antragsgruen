...
wir haben dir soeben Zugang zu unserer Antragsrot-Seite eingerichtet, auf der du über unseren Entwurf mitdiskutieren kannst.
Hier ist der Zugang:
...
Da <strong>kein E-Mail-Versand</strong> eingerichtet ist, musst du die <strong>Passwörter</strong> hier selbst erzeugen, im Klartext eingeben und selbst an die Nutzer:innen schicken.<br><br>Aus <strong>Datenschutzgründen</strong> wäre empfehlenswerter, zunächst den E-Mail-Versand einzurichten, damit Antragsrot automatisch Passwörter erzeugen und direkt an die Nutzer:innen schicken kann.',
...
Liebe Grüße,
  ...
  'translating_hint' => 'Auf dieser Seite können die Texte der Benutzeroberfläche von Antragsrot angepasst werden. Falls du eine komplett neue Sprache anlegen und allen anderen Nutzer:innen von Antragsrot bereit stellen willst, <a href="https://github.com/CatoTH">melde dich</a> einfach bei uns.<br><br><strong>Hinweis:</strong> Änderungen hier wirken sich nur auf die aktuelle Veranstaltung aus - auf keine andere.',
  ...
  'support_coll_policy_warning' => 'Wenn es vor dem Einreichen eines Antrags eine Unterstützungsphase gibt, wird empfohlen, sowohl zum Stellen als auch Unterstützen eines Antrags ein Login zu erzwingen. Außerdem ist eine E-Mail-Bestätigung an die Antragsteller:in empfehlenswert.',
