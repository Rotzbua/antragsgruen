...
<br>
Bitte beachte, dass sich die Unterstützer:innen deines Änderungsantrags mit ihren SAML-Zugangsdaten einloggen und darüber verifizieren müssen.',
  'submitted_adminnoti_title' => '[LaKo] Neuer Änderungsantrag',
  'submitted_adminnoti_body' => 'Es wurde ein neuer Änderungsantrag eingereicht.
Antrag: %TITLE%\\nAntragsteller:in: %INITIATOR%
Link: %LINK%',
  'submitted_screening_email' => 'Hallo,\\n\\ndu hast soeben einen Änderungsantrag eingereicht.\\nDer Antrag wird nun auf formale Richtigkeit geprüft und dann freigeschaltet. Du wirst dann gesondert darüber benachrichtigt.\\n\\nDu kannst ihn hier einsehen: %LINK%\\n\\nMit freundlichen Grüßen,\\n  Dein Landesvorstand',
  'submitted_screening_email_subject' => '[LaKo] Änderungsantrag eingereicht',
  'create_explanation' => 'Bitte ändere unten den ursprünglichen Antragstext so ab, wie du ihn gerne beschlossen haben möchtest.<br>Unter &quot;<strong>Begründung</strong>&quot; kannst du die Änderung begründen.<br>Falls Du über einen inhaltlichen  Änderungsantrag hinaus oder ausschließlich redaktionelle Hinweise zum Antrag geben möchtest, kannst du diese als "<strong>Redaktionelle Änderung</strong>" beifügen und entsprechend kennzeichnen.',
...
<li><strong>Änderungsantrag einbringen</strong>: Sobald sich %MIN% Unterstützer:innen gefunden haben, bekommst du eine Benachrichtigungs-E-Mail. Ab dann kannst du den Änderungsantrag offiziell einbringen. Auch danach ist es noch möglich, dass sich Unterstützer:innen für diesen Änderungsantrag eintragen.</li>
  ...
  'published_email_body' => 'Hallo,\\n\\ndein Änderungsantrag zu „%MOTION%“ wurde soeben veröffentlicht. Du kannst ihn hier einsehen: %LINK%\\n\\nMit freundlichen Grüßen,\\n  Dein Landesvorstand',
  'withdrawn_adminnoti_title' => '[LaKo] Änderungsantrag zurückgezogen',
  ...
  'proposal_email_title' => '[LaKo] Änderungsantrag %PREFIX%: Verfahrensvorschlag',
  'proposal_email_modified' => 'Hallo %NAME_GIVEN%,\\n\\ndie Sitzungsleitung hat über deinen Änderungsantrag beraten und will vorschlagen, ihn modifiziert zu übernehmen.\\n\\nBitte überprüfe unter folgendem Link, ob du mit der modifizierten Übernahme so einverstanden bist:\\n%LINK%\\n\\nMit freundlichen Grüßen,\\n  Dein Landesvorstand',
  'proposal_email_accepted' => 'Hallo %NAME_GIVEN%,\\n\\nzu Deiner Information: die Sitzungsleitung wird vorschlagen, deinen Änderungsantrag zu übernehmen.\\n\\nDu kannst ihn hier einsehen: %LINK%\\n\\nMit freundlichen Grüßen,\\n  Dein Landesvorstand',
